  ...
  useEffect(() => {
    ...
    const getAllAddresses = async () => {
      try {
        ...
        const memberAddresses = rolesAndMembers.minter;
  ...
  if (!address) {
    return (
      <div className="landing">
        <h1>Bem-vind@s à PurrosDAO - a DAO dos amantes de charrutos</h1>
        <div>
          <ConnectWallet />
        </div>
      </div>
  ...
  if (hasClaimedNFT) {
    return (
      <div className="member-page">
        ...
        <p>Parabéns por fazer parte dessa lounge de charutos!</p>
        <div>
          <div>
